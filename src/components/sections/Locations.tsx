...
const Locations = () => {
    return (
        <section id="locations" className="w-full bg-white text-black py-16 lg:py-32 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 lg:px-16">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif text-black leading-tight">Explore the Regions.</h2>
                </motion.div>
                    ...
                    {locationsData.map((city, idx) => (
                        ...
                        >
                            ...
                            <div className="w-full lg:w-[65%] overflow-hidden group cursor-ew-resize relative rounded-2xl">
                                {/* The Sliding Track */}
                                <div className="flex gap-4 transition-transform duration-1000 ease-out group-hover:-translate-x-[45%]">
